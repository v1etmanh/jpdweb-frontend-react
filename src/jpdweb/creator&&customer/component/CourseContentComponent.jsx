...
import PassageQuestionContainer from "./PassageQuestionContainer";
import SpeakingPage from "./SpeakingPage";
import WritingQuestionComponent from "./WritingQuestionComponent";
import { useEffect, useState } from "react";
import VideoPlayer from "./VideoPlayerComponent";
import PdfComponent from "./PdfComponent";
import WritingQuestionContainer from "./WritingQuestionContainer";
  ...
  const defineContent = () => {
    ...
    switch (data[0].typeOfContent) {
      ...
      case 'VIDEO':
        return (
          <div className="max-w-6xl mx-auto animate-fade-in">
            <VideoPlayerContainer videos={data}
                                  onComplete={onComplete}/>
          </div>
        );
